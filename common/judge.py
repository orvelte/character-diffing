...
def classify_many(system, users, labels, model=JUDGE_MODEL, workers=4, max_tokens=64):
...
def rate_scale_many(system, texts, lo=1, hi=7, model=JUDGE_MODEL, workers=4, max_tokens=8):
    from concurrent.futures import ThreadPoolExecutor
    with ThreadPoolExecutor(workers) as ex:
